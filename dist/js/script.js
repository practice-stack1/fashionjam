...
var windowHeight = document.documentElement.clientHeight; //? Висота екрана браузера без скролу

var loadMoreBlock = document.querySelector('._load-more');
var lazyImagesPositions = []; //! Масив з позиціями відносно верху сторінки усіх елементів з картинками
...
function lazyScroll() {
  if (document.querySelectorAll('img[data-src],source[data-srcset]').length > 0) {
    //? Так як ми кастомін атребути видаляємо, то дана перевірка не спрацює при відобрежені усіх елементів
    lazyScrollCheck();
  }
...
function loadMore() {
  ...
  var loadMoreBlockHeight = loadMoreBlock.offsetHeight; //! Отримуємо висоту блока в який ми маємо підгружати контент
...
/* harmony import */ var _basic_lazyload__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./basic/lazyload */ "./src/js/basic/lazyload.js");
/* harmony import */ var _basic_lazyload__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_basic_lazyload__WEBPACK_IMPORTED_MODULE_6__);
